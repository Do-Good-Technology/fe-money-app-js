  ...
  <Col span={24}>
    <Row>
      <Col span={4}>
        <Row justify="end">
          <Col>
            <Title level={2} style={{ color: "var(--neutral-80)" }}>
              28
            </Title>
          </Col>
        </Row>
      ...
      <Col span={6}>
        <Row justify="end">
          <Col>
            <Title level={5} style={{ color: "var(--red-default)" }}>
              - 132,000
            </Title>
          </Col>
        </Row>
    ...
    <Row>
      ...
      <Col span={12} offset={1}>
        <Row>
          ...
          <Col>
            <Text type="secondary">
              Gopay | Sedekah hari jumat via Kitabisa
            </Text>
          </Col>
        </Row>
      </Col>
      <Col span={6}>
        <Row justify="end">
          <Col>
            <Text strong style={{ color: "var(--red-default)" }}>
              - 5,000
            </Text>
          </Col>
        </Row>
